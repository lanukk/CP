...
void solve(int input)
{
	...
	int d;
	cin >> d;
	int number1 = lower_bound(all(prime), d + 1) - prime.begin();
	number1 = prime[number1];
	int number2 = lower_bound(all(prime), number1 + d) - prime.begin();
	number2 = prime[number2];
	cout << number1*number2 << line;
}
